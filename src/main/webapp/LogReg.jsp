...
<div class="login" style="margin-top:50px;">
   ...
   <div class="login-box">
    ...
    <form name="form2" id="regUser" accept-charset="utf-8"  action="${pageContext.request.contextPath}/login.action" method="post">
	      <input type="hidden" name="to" value="reg"/>
		      		       <input type="hidden" name="did" value="0"/>
        <ul class="reg_form" id="reg-ul">
        		<div id="usertip" class="cue">${requestScope.flag}</div>
                ...
                <div class="pwdArea" id="pwdArea">
              		 ...
              		 <div class="inputOuter" id="pArea">
                   		 <input type="password" id="p" name="loginPwd" class="inputstyle"/>
                	</div>
                </div>
    ...
    <div class="web_login">
        ...
        <ul class="reg_form" id="reg-ul">
                ...
                <label for="passwd" class="input-tips2">密码：</label>
                    <div class="inputOuter2">
                        <input type="password" id="passwd"  name="loginPwd" maxlength="16" class="inputstyle2"/>
                    </div>
                    
                </li>
                <li>
                <label for="passwd2" class="input-tips2">手机号码：</label>
                    <div class="inputOuter2">
                        <input type="text" id="passwd2" name="userPhone" maxlength="16" class="inputstyle2" />
                    </div>
                ...
                <li>
                 <label for="qq" class="input-tips2">邮箱：</label>
                    <div class="inputOuter2">
                        ...
                        <input type="text" id="qq" name="userEmail" maxlength="32" class="inputstyle2"/>
                    </div>
